...
('admin@pmc.mx', '$2a$10$44p.AJ6Ty73723nlLBXNYetIgXGKLdMcRgTXZYAw21GZfOZDLeF1q', 1, 1),
('citizen_uno@pmc.mx', '$2a$10$44p.AJ6Ty73723nlLBXNYetIgXGKLdMcRgTXZYAw21GZfOZDLeF1q', 1, 1),
('citizen_dos@pmc.mx', '$2a$10$44p.AJ6Ty73723nlLBXNYetIgXGKLdMcRgTXZYAw21GZfOZDLeF1q', 1, 1),
...
(1, 1, 'TELEFONO', '5544332211'),
(2, 1, 'TWITTER', '@Jorge'),
(3, 2, 'TELEFONO', '4477558899');

INSERT INTO GEO_LOCACION (ID, CALLE, NO_EXTERIOR, NO_INTERIOR, COLONIA, CODIGO_POSTAL, MUNICIPALITY_ID, LATITUDE, LONGITUDE) VALUES
(1, 'CALLE VIENA', '16', '', 'Col Juarez', '06600', 273, 19.430268, -99.157720);

INSERT INTO AYUDA (ID, DESCRIPCION, CIUDADANO_ID, GEO_LOCATION_ID, TIPO_AYUDA_ID, ORIGEN_AYUDA, FECHA_REGISTRO, ACTIVE) VALUES
(1, 'Necesito ir a mi cita de hemodiálisis 16:00', 1, 1, 3, 'SOLICITA', TIMESTAMP '2020-03-20 00:00:00.000', 1);
